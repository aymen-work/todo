...
<template>
    <div class="flex flex-wrap">
        <div class="flex items-center me-4">
            <input @change="status = 'completed'" type="radio" value="" name="colored-radio"
                class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-green-500 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="red-radio" class="ms-2 text-sm font-medium text-gray-900">Completed</label>
        </div>
        <div class="flex items-center me-4">
            <input @change="status = 'cancelled'" type="radio" value="" name="colored-radio"
                class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="green-radio" class="ms-2 text-sm font-medium text-gray-900 ">Cancelled</label>
        </div>
        <div class="flex items-center me-4">
            <input checked @change="status = 'pending'" type="radio" value="" name="colored-radio"
                class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 focus:ring-yellow-500 dark:focus:ring-yallow-400 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    ...
    <div v-if="data" v-for="t in data" @click="aa(t)" class="grid grid-flow-col mt-5 hover:cursor-pointer">
        ...
        <div class="col-span-1" v-if="t.status === 'pending'"><i class="pi pi-clock bg-blue-500 rounded-lg"></i>
        </div>
